...
class categoryClass:
    def __init__(self,root):
        ...
        cat_frame.place(x=800,y=100,width=420,height=100)
        ...
        self.category_table.heading("cid",text="Caategory ID")
        ...
        self.im1=self.im1.resize((590,370),Image.ANTIALIAS)
        ...
        self.im2=self.im2.resize((570,370),Image.ANTIALIAS)
        self.im2=ImageTk.PhotoImage(self.im2)
        
        self.lbl_im2=Label(self.root,image=self.im2,bd=2,relief=RAISED)
        self.lbl_im2.place(x=650,y=220)
