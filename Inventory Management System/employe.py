...
class employeeClass:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Employee Details",font=("gody old style",15),bg="#0f4d7d",fg="white").place(x=50,y=100,width=1170)
        ...
        txt_salary=Entry(self.root,textvariable=self.var_salary,font=("gody old style",15),bg="lightyellow").place(x=680,y=270,width=180)
        
        #=======Button================
        
        btn_add=Button(self.root,text="Save",command=self.add,font=("gody old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=600,y=305,width=120,height=28)
        btn_update=Button(self.root,text="Update",command=self.update,font=("gody old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=740,y=305,width=120,height=28)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("gody old style",15),bg="#f44336",fg="white",cursor="hand2").place(x=880,y=305,width=120,height=28)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("gody old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=1020,y=305,width=120,height=28)

        #=======================Employee Details View============================
        
        emp_frame=Frame(self.root,bd=3,relief=RIDGE)
        emp_frame.place(x=0,y=350,relwidth=1,height=265)
...
#==========================Insert============================
    ...
    def add(self):
        ...
        cur=con.cursor()
        try:
            if self.var_emp_id.get()==""or self.var_name.get()=="" or self.var_email.get()=="" or self.var_contact.get()=="" or self.var_dob.get()=="" or self.var_doj.get()=="" or self.var_pass.get()=="" or self.var_salary.get()=="":
