...
class Login_System:
    def __init__(self,root):
        self.root=root
        self.root.title("Login System | Developed By : Ansh")
        ...
        login_frame.place(x=850,y=140,width=350,height=460)
        ...
        #btn_forget=Button(login_frame,text="Forget Password ?",command=self.forget_window,font=("timesnew roman",13),bg="white",fg="#00759E",bd=0,activebackground="white",activeforeground="#00759E",cursor="hand2").place(x=100,y=400)
        ...
        self.lbl_change_image.place(x=417,y=192,width=240,height=428)
    ...
    def first_times(self):
        con=sqlite3.connect(database=r'ims.db')
        cur=con.cursor()
        cur.execute("select * from employee")
        employee=cur.fetchall()
        if len(employee)==0:
            os.system("python first_time.py") 
            ...
            if self.employee_id.get()=="":
                ...
                if email==None:
                    ...
                    if chk=='f':
                        ...
                        self.forget_win.geometry('400x350+830+250')
                        ...
                        self.btn_update=Button(self.forget_win,text="UPADTE",command=self.update_password,state=DISABLED,font=("times new roman",15),bg="lightblue",cursor="hand2")
    ...
    def update_password(self):
        if self.var_new_pass.get()=="" or self.var_conf_pass.get()=="":
            ...
            messagebox.showerror("Error","Password & Confiram Is Not Match",parent=self.forget_win)
        else:
            con=sqlite3.connect(database=r'ims.db')
            cur=con.cursor()
            try:
                ...
                con.commit()
                messagebox.showinfo("Success","Password Update Successfully",parent=self.forget_win)
